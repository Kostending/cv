                ...
                <ul>
                    {
                        Object.keys(stats).map(key => (
                            <li className={styles.statsContainer} key={key}>
                                <span className="stat-name">{key}</span><span className="stat-value">{stats[key]}</span>
                            </li>
                        ))
                    }
                </ul>
